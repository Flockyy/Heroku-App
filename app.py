...
movie_duration_list = movie_db['duration'].str.replace(':', 'h')
...
by_duration_input = st.sidebar.selectbox("Search by duration", sorted(movie_duration_list.unique(), reverse=True))
